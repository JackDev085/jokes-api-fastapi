...
<body>
  <div class="create_joke">
    <h1>Update a Joke</h1>
    <form action`=https://badjokesapi/api/jokes/update/` method="post" enctype="application/json">
...
<script>
  ...
  form.addEventListener("submit", async (e) => {
    ...
    await fetch(`https://badjokesapi.vercel.app/api/jokes/${id}/`, {
      method: "PUT",
      headers: {
